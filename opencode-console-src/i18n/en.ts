export const dict = {
  ...
  "app.meta.description": "Subvocal SDK - Physiological Silent Speech Interface Middleware.",

  "home.title": "Subvocal SDK | Physiological Silent Speech Interface Middleware",

  "temp.title": "Subvocal SDK | Physiological Silent Speech Interface Middleware",
  "temp.hero.title": "Physiological Silent Speech Interface Middleware",
  "temp.zen": "Subvocal SDK Zen",
  "temp.getStarted": "Get Started",
  "temp.feature.native.title": "Middleware Rails",
  "temp.feature.native.body": "Hardware-agnostic software interface connecting sEMG sensors to LLM-driven agents.",
  "temp.feature.zen.beforeLink": "A",
  "temp.feature.zen.link": "curated list of models",
  "temp.feature.zen.afterLink": "provided by Subvocal SDK",
  "temp.feature.models.beforeLink": "Supports popular LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "Subvocal SDK signal-to-intent pipeline layout",
  "temp.screenshot.alt": "Subvocal SDK signal-to-intent pipeline layout",
  "temp.logoLightAlt": "Subvocal SDK logo light",
  "temp.logoDarkAlt": "Subvocal SDK logo dark",

  "home.banner.badge": "v0.1.0",
  "home.banner.text": "SDK middleware is open source",
  "home.banner.platforms": "supporting OpenBCI, SpikerShield, and custom rigs",
  "home.banner.downloadNow": "View code",
  "home.banner.downloadBetaNow": "View the code on GitHub",

  "home.hero.title": "Physiological Silent Speech Interface Middleware",
  "home.hero.subtitle.a": "An open-source, hardware-agnostic SDK connecting surface electromyography interfaces",
  "home.hero.subtitle.b": "to LLM-driven AI agents via compressed articulatory shorthand decoders.",

  "home.install.ariaLabel": "Install options",

  "home.what.title": "What is Subvocal SDK?",
  "home.what.body": "Subvocal SDK is a library for sEMG bio-signal capture, digital signal processing, gesture classification, and context-aware natural language intent reconstruction.",
  "home.what.lsp.title": "Articulatory Shorthand",
  "home.what.lsp.body": "Bypasses the typical 5-8 whole-word vocabulary limit of standard sEMG classifiers.",
  "home.what.multiSession.title": "Asymmetric Levenshtein",
  "home.what.multiSession.body": "Aligns compressed phonetic shorthand inputs using custom physiological confusion clusters.",
  "home.what.shareLinks.title": "Context Prioritization",
  "home.what.shareLinks.body": "Dynamically filters and ranks candidate targets based on focused application states.",
  "home.what.copilot.title": "Signal Preprocessing",
  "home.what.copilot.body": "AlterEgo-inspired 1.3-50.0 Hz bandpass filtering defaults optimized for slow gestures.",
  "home.what.chatgptPlus.title": "Classifier Skeletons",
  "home.what.chatgptPlus.body": "Train Random Forest, 1D CNN, and GRU model topologies locally on raw traces.",
  "home.what.anyModel.title": "MCP Server",
  "home.what.anyModel.body": "Exposes intent-reconstruction decoders as standard Model Context Protocol tools.",
  "home.what.anyEditor.title": "Offline TTS",
  "home.what.anyEditor.body": "Zero-dependency local audio feedback engine prioritizing native macOS audio tools.",
  "home.what.readDocs": "View GitHub Repository",
