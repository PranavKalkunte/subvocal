...
# Inject software folder to path to enable direct script execution
script_dir = os.path.dirname(os.path.abspath(__file__))
software_path = os.path.abspath(os.path.join(script_dir, ".."))
...
from shorthand.vocab import get_command_list
