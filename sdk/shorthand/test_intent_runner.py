...
# Ensure sdk/ is in Python path for standalone script execution
script_dir = os.path.dirname(os.path.abspath(__file__))
sdk_path = os.path.abspath(os.path.join(script_dir, ".."))
if sdk_path not in sys.path:
    sys.path.insert(0, sdk_path)

from shorthand.eval_set import EVAL_SET
from shorthand.decoder import heuristic_decode_phrase
from shorthand.spec import compress_word
from context.schema import UserContext, AppState, Contact, CalendarEvent, UIElement
from core.models import CommandToken
from core.llm_providers import ClaudeProvider, OpenAIProvider, GeminiProvider, LlamaProvider
